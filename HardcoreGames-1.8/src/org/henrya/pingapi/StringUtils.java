...
public class StringUtils {
	...
	@SuppressWarnings("unused")
	private static final int MOTD_CENTER_PX = 132;
	@SuppressWarnings("unused")
	private static final int INVENTORY_CENTER_PX = 80;
	...
	public static String makeCenteredInventoryTitle(String message) {
		...
		int toCompensate = 80 - halvedMessageSize;
